...
def LDLTnormal(A,m,n):
    ...
    DLT=multip(D,trans(L,n,n),n,n,n)
    print 'La matriz L es:'
    for i in range(n):
        print L[i]
...
def ParletReid(A,m,n):
   ...
   #algoritmo#
    ...
    #EL P TOTAL#
        ...
        W=adq(PP,n,n)
    #M2P2M1P1#
        L= multip(multip(M,P,n,n,n),L,n,n,n)
    PPT=trans(PP,n,n)
